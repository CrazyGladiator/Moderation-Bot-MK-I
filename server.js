...
client.on("ready", () => {
 ...
 require('http').createServer((req, res) => res.end('AutomodBot is alive! Join support server')).listen(3000)


client.on
client.on("ready", () => {
    client.user.setActivity("cb help | Made By Crazy_Gladiator", { type: "PLAYING"})
})
...
console.log("Subscribe to Crazy_Gladiator")
